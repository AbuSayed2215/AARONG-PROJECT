...
public void user_clicks_on_the_sign_in_button() {
	...
	//PageFactory.initElements(driver, ElementPage.class).getloginButton().click();
}
...
public void user_clicks_on_final_sign_in_button() {
	//Tools.getExplicitWait(pf.getEnterSingin(), 5);
...
public void user_is_able_to_click_on_the_iteam() {
  ...
  //String expected = "Panjabi"; 
  boolean actual = pf.getGetPanjabi().getText().contains("Panjabi");
